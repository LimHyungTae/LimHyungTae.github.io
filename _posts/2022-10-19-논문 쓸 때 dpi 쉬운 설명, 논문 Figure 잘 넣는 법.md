...
comments: true
description: DPI 개념을 쉽게 풀고, 두 컬럼 LaTeX 논문에서 figure가 깨지지 않도록 한 컬럼 1050px, 두 컬럼 2100px 같은 픽셀 기준을 잡는 실전 가이드를 정리한다.
permalink: /2022/10/19/paper-figure-dpi-explained/
redirect_from:
