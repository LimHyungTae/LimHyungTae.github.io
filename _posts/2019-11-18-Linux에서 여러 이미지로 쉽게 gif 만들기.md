...
comments: true
description: Linux ImageMagick의 convert 명령어로 여러 png 이미지를 gif로 묶는 방법과, txt 리스트로 프레임 순서를 보장하고 loop 옵션으로 무한 반복 시키는 팁을 정리한다.
permalink: /2019/11/18/imagemagick-images-to-gif/
redirect_from:
  - '/2019-11-18-Linux에서 여러 이미지로 쉽게 gif 만들기/'
  - '/2019-11-18-Linux에서-여러-이미지로-쉽게-gif-만들기/'
---
