...
comments: true
description: MinkowskiEngine docker 환경 위에서 SPVNAS를 돌리기 위해 OpenMPI, torchpack, torchsparse, libsparsehash-dev 설치 과정과 자주 마주치는 에러 회피법을 정리한다.
permalink: /2024/06/01/spvnas-installation-setup/
redirect_from:
  - '/2024-06-01-SPVNAS 실행시키기 위한 설치 정리/'
  - '/2024-06-01-SPVNAS-실행시키기-위한-설치-정리/'
---
