...
comments: true
description: std::all_of, std::any_of, std::none_of로 컨테이너 조건 검사를 조기 종료(short-circuit)로 효율화하는 원리와 grid_map 라이브러리의 활용 사례를 정리한다.
permalink: /2024/01/01/modern-cpp-robotics-09-std-all-any-none-of/
redirect_from:
  - '/2024-01-01-Modern C++ for Robotics 9. std::all_of(), std::any_of(), std::none_of() 쉬운 설명/'
---
