...
Robotics 분야에서 개발/연구를 하다 보면 밥 먹듯이 해야 하는 것이 transformation입니다. 왜냐하면 robot의 system에서 기술해야 하는 수많은 좌표축(frame)이 존재하기 때문입니다. 위의 그림과 같이 LiDAR sensor가 하나만 달려있는 로봇이어도 최소 3가지 축이 존재합니다.
