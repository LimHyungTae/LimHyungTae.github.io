...
참고 매뉴얼은 [여기](https://dev.intelrealsense.com/docs/tuning-depth-cameras-for-best-performance)와 [여기](https://dev.intelrealsense.com/docs/depth-post-processing)입니다.
...
매뉴얼에도 temporal filter가 D435i가 어느정도 static한 상황에서도 좋다고 명시되어 있습니다.
