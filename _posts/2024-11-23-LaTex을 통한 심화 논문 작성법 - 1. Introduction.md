...
tags: [LaTex]
comments: true
description: 대학원생이 LaTeX으로 장편 저널 논문을 작성할 때 어떻게 하면 더 효율적으로 협업하고 human error를 줄일 수 있는지 다루는 심화 시리즈의 도입부이다.
permalink: /2024/11/23/latex-paper-writing-01-introduction/
redirect_from:
  - '/2024-11-23-LaTex을 통한 심화 논문 작성법 - 1. Introduction/'
  - '/2024-11-23-LaTex을-통한-심화-논문-작성법-1.-Introduction/'
---
...
그 과정에서 공통된 실수들을 발견했고, 이 실수들은 저자들이 의도한 것은 분명히 아닐테지만, 너무 반복되어서 논문을 고쳐주는데 피로감을 느끼게 되었다(나는 내용에 집중하고 싶지, 논문 template을 다듬는데 시간을 최소한으로 쓰고 싶다. 물론 필연적으로 그럴 수 없지만....)
...
(그리고 더 이상 how에 대해서 블로그 글을 적는 것은 무의미하다. ChatGPT한테 물어보면 되는 걸!)
