...
subtitle: 2. Quaternion이나 Euler angles을 변수화할 때 순서를 명시하자
...
### 2. Quaternion이나 Euler angles을 변수화할 때 순서를 명시하자
