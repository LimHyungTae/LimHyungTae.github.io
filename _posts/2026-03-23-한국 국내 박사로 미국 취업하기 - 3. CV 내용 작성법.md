---
layout: post
title: 한국 국내 박사로 미국 취업하기 - 3. CV 작성 (2): 내용 작성하기
subtitle: Publication-Driven에서 Project-Driven으로, XYZ Formula로 연구를 임팩트로 전환하기
tags: [Career, PhD, BigTech, Resume, SLAM, Robotics, ATS]
comments: true
---
...
"Published 15 papers at ICRA, RSS, RA-L" → OK, 논문 많이 썼구나.
"Built a large-scale LiDAR-inertial SLAM system enabling real-time mapping in airport-scale environments" → 오, 이 사람이 만든 게 있구나.
...
JD에 나오는 키워드를 resume에 자연스럽게 녹여야 ATS 점수가 올라간다.
로보틱스/AV 관련 포지션이라면 아래 키워드들을 체크해보자.
