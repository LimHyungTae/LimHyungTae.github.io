---
layout: post
title: Ouster OS1-64 ROS 세팅하는 법
subtitle: Ouster OS1-64
tags: [SLAM, LiDAR, Pointcloud, ROS, Ouster, OS1]
comments: true
description: Ouster OS1-64 드라이버를 catkin 워크스페이스에 빌드한 뒤 발생하는 md5sum 에러 원인을 분석하고, PacketMsg에 std_msgs/Header를 추가해 timestamp를 찍어 해결하는 방법을 정리한다.
image: /img/ouster_error.png
permalink: /2020/11/15/ouster-os1-64-ros-setup/
redirect_from:
  - '/2020-11-15-Ouster OS1-64 ROS 세팅하는 법/'
---
...
![error_occurs](/img/ouster_error.png)    
