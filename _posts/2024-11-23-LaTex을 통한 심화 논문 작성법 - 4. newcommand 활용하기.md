...
이번 글에서는 `\newcommand`를 활용하는 방법을 다룬다.
[1편](https://limhyungtae.github.io/2024/11/23/latex-paper-writing-01-introduction/)에서 강조했듯이, 인간은 누구나 논문을 작성할 때 실수를 하게 되어 있다.
...
정신 차리고 쓰면 된다고? 다 내가 아래와 같이 human error로 영구히 박제당한 경험으로 피토하며 얻은 교훈이니 꼭 좀 따라주길...

아래는 `i`라고 쓰던 것을 `k`로 바꾸는 과정에서 미처 발견하지 못한 typo이다 (see (6)):
